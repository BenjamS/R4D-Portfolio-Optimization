...
The standard solution to the credible commitment problem is recourse to an independent, impartial, third party tribunal mechanism trusted by all participants [@north1993institutions]. The portfolio optimization method proposed here is designed to fulfill or at least support this role. Whereas budget allocations generated under the current, highly subjective decision-making protocol are essentially a matter of opinion, and hence optimal from some points of view but sub-optimal from others, the mathematical solution presented here is not subject to this criticism. Subjective bias may still creep into the process at the information gathering and impact assessment stages (Mills' steps 2 and 3), but the proposed budget allocation mechanism itself guarantees an optimal solution insofar as this information is accurate.
...
scale with investment...may be better to programs...

* key methodological challenges in this ... were ensuring real, positive valued budget allocations.

* suboptimal solutions

* The portfolio of projects described in Fig \ref{fig:params} is diverse in research themes, impact pathways, expected rewards, risk levels, time horizons, and stages of implementation. Real AR4D portfolios may or may not be so heterogeneous.
...
* The proposed method is applicable for projects whose impacts scale with investment. This is not always true for projects. The investment model in section ... does not account for a minimum required amount, beneath which it makes no sense to invest. only way is to increase the budget size  It may make more sense to apply the method at a program level.

* can also use for trait portfolio optimization ...not limited to the AR4D...but applicable to any multi-objective portfolio optimization workflow.
...
* Up for rebalancing at the end of every funding cycle (3 years). i.e. the allocation is repeated with updated parameters. Some projects may exit while others enter.
