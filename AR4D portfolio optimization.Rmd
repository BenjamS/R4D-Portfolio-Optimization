...
Note, moreover, that the adjustment made to the time horizon may either be an extension ($\kappa > 0$) or a contraction ($\kappa \leq 0$).
...
To guarantee real valued $w_k$, then, it is useful to introduce the decision parameter $\kappa_k$ into the definition of $w_k$, as follows.
