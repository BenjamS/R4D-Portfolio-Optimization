...
Substituting the right hand side of Eq \ref{eq:npvFnW} for $x_k(0)$ wherever it appears, expected project NPV $\mu_k$ becomes a function of investment
...
And likewise for project NPV variance and covariance $\sigma_{jk}$, and the coefficients of covariation $c_{jk}$.
...
With no loss of generality, the control variables $\mathbf{w}$ may be swapped for $\boldsymbol{\mu}$.
