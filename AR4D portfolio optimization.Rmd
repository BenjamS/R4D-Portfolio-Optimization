...
These upper and lower error margins on the expected arithmetic return $r$ may then be interpreted as the upper and lower bounds of a $95\%$ confidence interval. The arithmetic return $r$ can be converted to a log return by the formula
