...
Agricultural research for development (AR4D) projects tend to be high risk (if high reward) propositions with long time horizons, such that project net present value is likely to fluctuate considerably over the life of the project. Donors, meanwhile, face increasingly austere fiscal outlooks that restrict their ability to commit to the long time horizons of agricultural research.
...
Real options valuation [@trigeorgis1993real; @mcgrath2000assessing] presents a potential mechanism by which researchers can secure long term funding while providing fiscally constrained donors with the flexibility they require to justify long term commitments. The notion of real options valuation is born of the analogous concept of European call options in the financial context. The holder of a European call option on an underlying security (a stock, for example) has the right, but not the obligation, to purchase the security for a predetermined price at the end of a certain time period. If the predetermined price is higher than the security price at the end of the time period, it is in the investor's best interest to exercise their right. If not, they are under no obligation to do so. The predetermined price at which the investor agrees to buy the security if they so choose is called the "strike price" or "exercise price".

Analogously, investors who "buy a real option" commit to funding a real project for a certain time period, at the end of which they have the right, but not the obligation, to continue funding the subsequent stage of the project. In research contexts, the subsequent stage in question is usually the launch and scaling up of a proof of concept developed during the main stage of the project. ... [], for example, evaluate the real option value of a project to develop a new consumer electronics product at a private sector tech firm. The exercise price, in this case, is the cost of establishing the plant capacity required to manufacture the new product at scale, plus advertising and any other marketing costs.



[Real options valuation has been applied to numerous research and non-research private sector project contexts. (For a taxonomy, see Trigeorgis [-@].)] In the present article, we extend real options valuation to AR4D projects.    Donors effectively have and exercise this option anyway, as AR4D project funding agreements are usually up for renewal/cancelation every 3-5 years. Somewhat unfairly for researchers, default methods of project appraisal fail to price in this option value.
